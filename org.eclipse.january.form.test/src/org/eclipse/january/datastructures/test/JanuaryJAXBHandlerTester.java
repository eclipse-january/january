...
/**
 * <p>
 * The JanuaryJAXBHandlerTester is responsible for testing the checks the
 * JanuaryJAXBHandler to ensure that it can read and write to the streams
...
public class JanuaryJAXBHandlerTester {
	/**
	 * 
	 */
	 ...
	 * 
	 */
	private JanuaryJAXBHandler iCEJAXBManipulator;
	...
	public void setupTests() {
		...
		// Initialize the test class and JanuaryJAXBHandler
		simpleJAXBTestClass = new SimpleJAXBTestClass();
		iCEJAXBManipulator = new JanuaryJAXBHandler();
	...
	/**
	 * <p>
	 * This operation checks the JanuaryJAXBHandler to ensure that it can read
	...
	/**
	 * <p>
	 * This test checks the behavior JanuaryJAXBHandler.read() operation when a
	...
	/**
	 * <p>
	 * This test checks the behavior JanuaryJAXBHandler.write() operation when a
	...
	/**
	 * <p>
	 * This test checks the behavior JanuaryJAXBHandler.read() operation when an
	...
	/**
	 * <p>
	 * This test checks the behavior JanuaryJAXBHandler.write() operation when
