...
public class ListComponentTester implements IElementSource<Integer>,
	...
	public void checkXMLPersistence()
		...
		// Create a list to hold JanuaryObjects and put one in it.
		ListComponent<JanuaryObject> objList = new ListComponent<JanuaryObject>();
		JanuaryObject obj = new JanuaryObject();
		obj.setId(777777);
		objList.add(obj);
		...
		// Create a list to hold JanuaryResources and put one in it.
		ListComponent<JanuaryResource> resList = new ListComponent<JanuaryResource>();
		...
		JanuaryResource res = new JanuaryResource(file);
		JanuaryResource res2 = new JanuaryResource(file2);
