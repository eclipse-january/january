...
public class InternalOBJLexer extends Lexer {
    ...
    public final void mRULE_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1585:14: ( '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalOBJ.g:1585:16: '#' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match('#'); 
            // InternalOBJ.g:1585:20: (~ ( ( '\\n' | '\\r' ) ) )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_NORMAL() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1587:13: ( 'vn' RULE_DOUBLE RULE_DOUBLE RULE_DOUBLE )
            // InternalOBJ.g:1587:15: 'vn' RULE_DOUBLE RULE_DOUBLE RULE_DOUBLE
            {
            match("vn"); 
    ...
    public final void mRULE_DOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1589:13: ( ( '-' | '+' )? ( RULE_INT )? '.' RULE_INT ( ( 'E' | 'e' ) ( '-' | '+' )? RULE_INT )? )
            // InternalOBJ.g:1589:15: ( '-' | '+' )? ( RULE_INT )? '.' RULE_INT ( ( 'E' | 'e' ) ( '-' | '+' )? RULE_INT )?
            {
            // InternalOBJ.g:1589:15: ( '-' | '+' )?
            int alt4=2;
            ...
            // InternalOBJ.g:1589:26: ( RULE_INT )?
            int alt5=2;
            ...
            match('.'); 
            mRULE_INT(); 
            // InternalOBJ.g:1589:49: ( ( 'E' | 'e' ) ( '-' | '+' )? RULE_INT )?
            int alt7=2;
            ...
            switch (alt7) {
                case 1 :
                    // InternalOBJ.g:1589:50: ( 'E' | 'e' ) ( '-' | '+' )? RULE_INT
                    {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1591:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalOBJ.g:1591:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalOBJ.g:1591:11: ( '^' )?
            int alt8=2;
            ...
            // InternalOBJ.g:1591:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop9:
            do {
                int alt9=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1593:10: ( ( '0' .. '9' )+ )
            // InternalOBJ.g:1593:12: ( '0' .. '9' )+
            {
            // InternalOBJ.g:1593:12: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1595:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalOBJ.g:1595:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalOBJ.g:1595:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt13=2;
            ...
            switch (alt13) {
                case 1 :
                    // InternalOBJ.g:1595:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalOBJ.g:1595:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop11:
                    do {
                        int alt11=3;
                    ...
                    break;
                case 2 :
                    // InternalOBJ.g:1595:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalOBJ.g:1595:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop12:
                    do {
                        int alt12=3;
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1597:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalOBJ.g:1597:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalOBJ.g:1597:24: ( options {greedy=false; } : . )*
            loop14:
            do {
                int alt14=2;
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1599:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalOBJ.g:1599:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalOBJ.g:1599:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop15:
            do {
                int alt15=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1601:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalOBJ.g:1601:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalOBJ.g:1601:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt18=0;
            loop18:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalOBJ.g:1603:16: ( . )
            // InternalOBJ.g:1603:18: .
            {
            matchAny(); 
