 ...
 * <ul>
 *   <li>{@link org.eclipse.january.geometry.xtext.iGES.impl.ParametersImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters
{
   ...
   * @ordered
   */
  protected EList<PEntry> entries;
  ...
  {
    return IGESPackage.Literals.PARAMETERS;
  }
   ...
   * @generated
   */
  public EList<PEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<PEntry>(PEntry.class, this, IGESPackage.PARAMETERS__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IGESPackage.PARAMETERS__ENTRIES:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case IGESPackage.PARAMETERS__ENTRIES:
        getEntries().clear();
        getEntries().addAll((Collection<? extends PEntry>)newValue);
        return;
    }
