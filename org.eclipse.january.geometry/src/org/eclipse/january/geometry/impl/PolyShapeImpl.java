...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Poly Shape</b></em>'.
 * <!-- end-user-doc -->
 * <p>
		...
		for(Face face : faces) {
			...
			if (indices.size() > 2) {
				for(int i=1; i<indices.size()-1; i++) {
					Vertex v1 = (Vertex) getVertexSource().getVertices().get(indices.get(0)-1).clone();
					Vertex v2 = (Vertex) getVertexSource().getVertices().get(indices.get(i)-1).clone();
					Vertex v3 = (Vertex) getVertexSource().getVertices().get(indices.get(i+1)-1).clone();
