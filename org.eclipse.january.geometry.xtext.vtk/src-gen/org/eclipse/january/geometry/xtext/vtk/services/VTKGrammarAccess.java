 ...
 */
package org.eclipse.january.geometry.xtext.vtk.services;
...
public class VTKGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GeometryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Geometry");
	...
	public class VertexSourceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.VertexSource");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		//VertexSource:
		//	{VertexSource} ('POINTS' EString? ENDLINE?)?
		//	vertices+=Vertex+;
		@Override public ParserRule getRule() { return rule; }
	...
	public class FaceElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Face");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PolyShapeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.PolyShape");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TriangleStripPolyShapeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.TriangleStripPolyShape");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class VertexElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.Vertex");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public VTKGrammarAccess(GrammarProvider grammarProvider,
		...
		this.tENDLINE = (TerminalRule) GrammarUtil.findRuleForName(getGrammar(), "org.xtext.example.mydsl.MyDsl.ENDLINE");
