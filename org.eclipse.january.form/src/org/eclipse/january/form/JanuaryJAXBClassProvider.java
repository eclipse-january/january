...
/**
 * The JanuaryJAXBClassProvider is a realization of the IJAXBClassProvider that
 * provides a list of classes that the XMLPersistenceProvider's JAXBContext must
 * be aware of when marshalling/unmarshalling January data structures.
 * 
 * @author Alex McCaskey
 *
 */
public class JanuaryJAXBClassProvider implements IJAXBClassProvider {
	...
	public String getProviderName() {
		return "January JAXB Class Provider";
	}
